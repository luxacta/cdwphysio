...
//           return;
//         }
//         window.location.href = "/"; // Adjust to your dashboard
//       } else {
//         const { error } = await authClient.signUp.email({
//           email,
//           password,
//           name: name!, // Assert non-null since name is required for registration
//         });
//         if (error) {
//           alert(error.message || "An error occurred.");
//           return;
...
//         window.location.href = "/auth/waiting-verification";
//       }
//     } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (isLogin) {
        ...
        toast.success("Check your inbox and verify your email.");
