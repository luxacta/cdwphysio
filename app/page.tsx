...
export default function Home() {
  return (
    <header
      className="relative top-0 h-full w-full flex flex-col before:bg-[url('/assets/img/banner-bg.jpg')] before:bg-no-repeat before:bg-center before:bg-cover before:absolute before:inset-0 before:top-10 before:-z-10 before:opacity-12">
      {/* Header Top */}
      <div className="relative header-top">
        <div
          className="flex items-center justify-center md:justify-between py-4 md:py-2.5 mx-4 sm:container sm:mx-auto">
          ...
          <div className="flex h-5 justify-between items-center space-x-3">
            ...
            <Link href="/" className="hover:text-cdw-primary transition-all flex items-center gap-x-2">
      ...
      <div className="header-nav">
        <Link href="/" className="w-32 block space-y-0.5">
          ...
          <div className="w-full font-bold text-center text-md text-shadow-2xs text-cdw-secondary">
            Data Warehouse
          </div>
          <Separator className="bg-cdw-secondary !h-[1.5px] dark:bg-white"/>
        </Link>
      ...
      <div
        className="px-4 px-4 pt-6 sm:container sm:mx-auto box-border relative flex flex-wrap w-full space-y-6 flex-1 min-h-[400px] items-center">
        <div className="w-full md:w-1/2 max-w-xl">
          <h1
            className="text-3xl lg:text-4xl xl:text-5xl leading-tight font-medium mb-3 font-outfit text--accent-foreground">
            Unleash Your Research -<br/> Bone Fracture Data Warehouse
          </h1>
          <p className="leading-normal text-muted-foreground">
            CDWPhysio is a free, secure, cloud-based repository designed for storing and sharing bone fracture
            research data. It ensures your datasets are easily accessible, shareable, and citable, supporting
            collaboration and reproducibility in bone fracture studies, no matter where you are.
          </p>
          <div className="mt-8 space-x-4 space-y-4">
            ...
            <Button
              ...
              border-primary cursor-pointer" variant="outline">
        ...
        <div className="relative max-w-xl self-end">
          <Image
            src="/assets/img/banner-2-img-1.png" alt="Image"
            width="400" height="400"
            className="max-w-60 md:max-w-[31.21vw] lg:max-w-md"
          />
          <Image
            src="/assets/img/banner-2-img-2.png" alt="Image"
            width="400" height="400"
