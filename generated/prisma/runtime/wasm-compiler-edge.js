...
function uu(e) {
  let r = Object.getOwnPropertyNames(DataView.prototype).filter((a) => a.startsWith("get") || a.startsWith("set")),
    ...
    i = (a, f) =>
      function (w = 0) {
        return Y(w, "offset"), de(w, "offset"), ee(w, "offset", this.length - 1), new DataView(this.buffer)[r[a]](w, f);
      },
    o = (a, f) =>
      function (w, A = 0) {
  ...
  c = ye(() => {
    ...
    h = class e extends Uint8Array {
      ...
      copy(t, r = 0, n = 0, i = this.length) {
        ee(r, "targetStart"), ee(n, "sourceStart", this.length), ee(i, "sourceEnd"), (r >>>= 0), (n >>>= 0), (i >>>= 0);
        let o = 0;
...
function jp(e, t, r) {
  let n = {};
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Qp(n, t, e), Hp(n, r, e), n
  );
}
function Qp(e, t, r) {
...
var Ac = 3,
  ...
  Gr = class {
    ...
    async url(t) {
      return (
        await this.start(), `${this.protocol}//${this.host}/${this.remoteClientVersion}/${this.inlineSchemaHash}/${t}`
      );
    }
    async uploadSchema() {
