...
function Xd(e, r, t) {
  let n = {};
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), r && em(n, r, e), rm(n, t, e), n
  );
}
function em(e, r, t) {
...
var Dl = 3,
  ...
  qt = class {
    ...
    async url(r) {
      return (
        await this.start(), `${this.protocol}//${this.host}/${this.remoteClientVersion}/${this.inlineSchemaHash}/${r}`
      );
    }
    async uploadSchema() {
